...
package com.example.klinten.myapplication.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.example.klinten.myapplication.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Firebase firebase = new Firebase("https://fiery-torch-7902.firebaseio.com/");
        firebase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("nagger@fierybase-2400.appspotmail.com",
                            "TodoList Nagger"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("skwasiba@roc-dev.com", "Recipient"));
